...
st.text("followed by Diesel with about 3,700 that being 7.1%, leaving electric as the lowest % out of")
st.text("all the cars being 0.01 due to electric cars only being 6 of them in total.")
...
st.text("the price of the vehicle declines as the odometer level increases, for exception of some cars")
st.text("which could be classic cars or electric cars that often aren't affect by the amount of miles.")
